//! Binance Spot provider capabilities.
...
/// Binance Spot provider capabilities.
///
/// - Bracket orders: Not supported natively
/// - OCO orders: Supported for all symbols
/// - OTO orders: Not supported natively
#[derive(Debug, Default, Clone)]
pub struct BinanceSpotCapabilities;

impl BinanceSpotCapabilities {
    #[must_use]
    pub fn new() -> Self {
        Self
    }
...
impl ProviderCapabilities for BinanceSpotCapabilities {

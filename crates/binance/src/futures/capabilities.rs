//! Binance Futures provider capabilities (USDS-M).
...
/// Binance Futures provider capabilities (USDS-M Futures).
#[derive(Debug, Default, Clone)]
pub struct BinanceFuturesCapabilities;

impl BinanceFuturesCapabilities {
    #[must_use]
...
impl ProviderCapabilities for BinanceFuturesCapabilities {

...
## [0.3.0](https://github.com/Tektii/trading-gateway/compare/v0.2.0...v0.3.0) (2026-08-08)


### ⚠ BREAKING CHANGES

* **core:** cancel_associated_orders is removed from ClosePositionRequest and no longer appears in the OpenAPI spec. Requests that still include it are accepted and the field is ignored.

### Features

* **alpaca,saxo:** report the entry order behind native bracket legs ([#134](https://github.com/Tektii/trading-gateway/issues/134)) ([edf97da](https://github.com/Tektii/trading-gateway/commit/edf97da6fbf4bd35f7770408b01d39f6cf117221))
...
* **mock:** simulate partial fills in the mock provider ([#133](https://github.com/Tektii/trading-gateway/issues/133)) ([e7691fa](https://github.com/Tektii/trading-gateway/commit/e7691fa733aeda3b29411ec6255b5462122e6986))
...
* **oanda:** target a specific trade when reducing on a hedging account ([#131](https://github.com/Tektii/trading-gateway/issues/131)) ([832ce00](https://github.com/Tektii/trading-gateway/commit/832ce00fa2b3836fd10f87ff27fe40adfda123fd))
...
* **core:** drop unused cancel_associated_orders from close request ([#139](https://github.com/Tektii/trading-gateway/issues/139)) ([15eef92](https://github.com/Tektii/trading-gateway/commit/15eef92650afa3dc45a6d625580d3e58afe0a5ac))
...
* **main:** silence unused_async on register_adapter for saxo-less builds ([#137](https://github.com/Tektii/trading-gateway/issues/137)) ([9e8fe1c](https://github.com/Tektii/trading-gateway/commit/9e8fe1c28829a4730ea17c6e77e0c7a9bd2130e8))
...
* **oanda:** report the position each fill acted on ([#129](https://github.com/Tektii/trading-gateway/issues/129)) ([b6b976e](https://github.com/Tektii/trading-gateway/commit/b6b976edc8bb91f40e60a58e0ab5ae3ef18ca276))
...
* **oanda:** send positionFill so reduce-only exits cannot open a trade ([#130](https://github.com/Tektii/trading-gateway/issues/130)) ([188081e](https://github.com/Tektii/trading-gateway/commit/188081e8815e4d3d72c5599dfb434385dd5b4731))
...
* **tektii:** advertise stop-limit in provider capabilities ([#140](https://github.com/Tektii/trading-gateway/issues/140)) ([45d6854](https://github.com/Tektii/trading-gateway/commit/45d68548422c40ae416b1627eac64f48b22e94a0))
...
* **tektii:** send every requested order status to the engine ([#135](https://github.com/Tektii/trading-gateway/issues/135)) ([5d7060a](https://github.com/Tektii/trading-gateway/commit/5d7060acade13cb2c82207ec9463b9d4c83f7f0f))
